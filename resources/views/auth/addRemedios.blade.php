    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <nav id="template-navbar" class="navbar navbar-default custom-navbar-default2 navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="section-content" style="right:0px; display: block; transform: translate3d(450px, -30px, 0px);" >
                        ...
                        <a class="navbar-brand" href="/">
                            <img id="logo2" src="{{asset('images/Logo_main2.png')}}" class="logo2 img-responsive">
                        </a>
                    </div>
                                           ...
                                           @csrf
                                            ...
                                            <h3>Informações</h3>
                                                ...
                                                <div class="col-md-7 col-sm-12">
                                                    <div class="form-group ">
                                                      <textarea  name="descricao" type="text" rows="5" id="descricao" maxlength="100"  placeholder="Descrição do Remédio" class="{{ $errors->has('descricao') ? ' is-invalid' : '' }} form-control empty" name="descricao" value="{{ old('descricao') }}" required autofocus></textarea>
                ...
                <br> <br><br>
                                <footer class="footer2 fixed-bottom">
                                    <div class="container">
                                        <div class="row">
