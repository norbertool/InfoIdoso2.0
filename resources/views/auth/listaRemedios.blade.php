<html lang="en">
    <head>
        ...
        <title>Listagem de Remédios</title>
        ...
        <nav id="template-navbar" class="navbar navbar-default custom-navbar-default2 navbar-fixed-top" >
            <div class="container" >
                ...
                <div id="loader" class="loader"></div>
                    <div class="section-content" style="right:0px; display: block; transform: translate3d(0px, -2px, 0px);" >
                        ...
                        <div class="container">
                            ...
                            @endif
                                    ...
                                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                                        ...
                                        <td width="50px;"><a style="color: white;" class="iconified text-align:right">{{++$x}}</a></td>                                           
                                            <td><span data-tooltip3="{{$p->descricao}}"> <a style="color: white;">{{$p->nome}}</a></td>
                                            
                                            
                                            <td width="110px;">
                                                <a style="color: white;" href="/remedios/remove/{{$p->id}}" onclick="return confirm('Deseja mesmo excluir este item?');">Remover</a>
                                            </td>
