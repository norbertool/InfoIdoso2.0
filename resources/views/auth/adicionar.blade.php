                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-3 col-sm-10 col-sm-offset-1">
                                    <div class="row">
                                        <form class="contact-form " method="post" action="/idosos/cadastro" enctype="multipart/form-data">
                                           @csrf
                                            ...
                                            <h3>Dados Pessoais</h3>
                                                ...
                                                <div class="col-md-7 col-sm-6">
                                                    <div class="form-group">
                                                        <textarea name="descricaop" type="text" rows="5" required="required" placeholder=" Descreva sobre a doença assinalada a cima."  id="descricaop" class="form-control empty iconified {{ $errors->has('descricaop') ? ' is-invalid' : '' }} iconified empty" name="descricaop" value="{{ old('descricaop') }}"required> </textarea>
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                        <div class="form-group">
                                                            <h5>
                                                            Física:&nbsp;<input type="checkbox" name="doencaf" id="doencaf"  value="F" class="{{ $errors->has('doencaf') ? ' is-invalid' : '' }} iconified empty" name="doencaf" value="{{ old('doencaf') }}"required>
                                                ...
                                                <div class="col-md-7 col-sm-6">
                                                    <div class="form-group">
                                                        <textarea name="descricaof" type="text" rows="5" required="required" placeholder=" Descreva sobre a doença assinalada a cima."  id="descricaof" class="form-control empty iconified {{ $errors->has('descricaof') ? ' is-invalid' : '' }} iconified empty" name="descricaof" value="{{ old('descricaof') }}"required> </textarea>
                                                ...
                                                <h3>Para contato</h3>
                                                    ...
                                                    <div class="col-md-3 col-sm-6">
                                                        <div class="form-group ">
                                                            <input  name="telefone1" type="text"  id="telefone1"   maxlength="14" placeholder=" Telefone"  onkeydown="javascript: fMasc( this, mTel );" class="{{ $errors->has('telefone1') ? ' is-invalid' : '' }} form-control empty" name="telefone1" value="{{ old('telefone1') }}" required autofocus>
                                                    ...
                                                    <div class="col-md-3 col-sm-6">
                                                        <div class="form-group">
                                                            <input  name="telefone2" type="text"  id="telefone2"  maxlength="14" placeholder=" Telefone"  onkeydown="javascript: fMasc( this, mTel );" class="{{ $errors->has('telefone2') ? ' is-invalid' : '' }} form-control empty" name="telefone2" value="{{ old('telefone2') }}" required autofocus>
                                                                    ...
                                                                    <div class="btn btn-default image-preview-input">
                                                                        <span class=""></span>
                                                                            <span class="">Procurar</span>
                                                                                <input type="file" accept="image/png, image/jpeg" name="foto" id="foto" class="form-control empty iconified {{ $errors->has('foto') ? ' is-invalid' : '' }} iconified empty" name="foto" value="{{ old('foto') }}"required/> <!-- rename it -->
                                                                                    @if ($errors->has('foto'))
                                                                                        <span class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-2 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="id_entidade" type="hidden" value="{{$funcionario->id_entidade}}" id="id_entidade" size="200"  class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} form-control empty iconified" name="id_entidade" required />
