                                        ...
                                        <form class="contact-form" method="post" action="funcionarios/cadastro">
                                           @csrf
                                            ...
                                            <div class="col-md-offset-0">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input name="telefone" type="tel" id="telefone" maxlength="14" placeholder=" Telefone" onkeydown="javascript: fMasc( this, mTel );" class="{{ $errors->has('telefone') ? ' is-invalid' : '' }} form-control empty" name="telefone" value="{{ old('telefone') }}"
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    <div class="form-group">
                                                        <input  name="confirm_password" type="password" class="form-control empty " id="confirm_password" required="required" placeholder=" Confirme sua senha">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <input  name="cpf" type="text" id="cpf" maxlength="14" placeholder=" CPF" onkeydown="javascript: fMasc( this, mCPF );"  class="{{ $errors->has('cpf') ? ' is-invalid' : '' }} form-control empty" name="cpf" required>
                                                         @if ($errors->has('cpf'))
                                                        <span class="invalid-feedback">
                                                    ...
                                                    <div class="form-group ">
                                                        <input  name="rg" type="text" id="rg" maxlength="9"  placeholder=" RG"  class="{{ $errors->has('rg') ? ' is-invalid' : '' }} form-control empty" name="rg" required>
                                                         @if ($errors->has('rg'))
                                                        <span class="invalid-feedback">
                                        ...
                                        <div class="col-md-10 col-md-offset-3 col-sm-10 col-sm-offset-0">
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-2 col-sm-6">
                                                            <input name="uf" type="text" id="uf" maxlength="2" size="6" placeholder=" Estado" class="{{ $errors->has('uf') ? ' is-invalid' : '' }} form-control empty iconified" name="uf" required />
                                                            @if ($errors->has('uf'))
                                                                <span class="invalid-feedback">
                                                ...
                                                <div class="col-md-5 col-lg-offset-0">
                                                    <div class="form-group ">
                                                        <select  name="id_entidade" id="id_entidade" class="div-select form-control">
                                                            <option name="id_entidade" id="id_entidade" value="1" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Lar São Francisco de Assis</option>
                                                            <option name="id_entidade" id="id_entidade" value="2" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Instituto Coronel João Leite</option>
                                                            <option name="id_entidade" id="id_entidade" value="3" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Sociedade Santo Antônio</option>
                                                            <option name="id_entidade" id="id_entidade" value="4" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Conferência São Vicente de Paula</option>
                                                            <option name="id_entidade" id="id_entidade" value="5" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Casa de Repouso Emanuel</option>
                                                            <option name="id_entidade" id="id_entidade" value="6" class="{{ $errors->has('id_entidade') ? ' is-invalid' : '' }} iconified empty" name="id_entidade" value="{{ old('id_entidade') }}"required>Juca de Andrade Vila Pahin</option>
                                                        </select>
