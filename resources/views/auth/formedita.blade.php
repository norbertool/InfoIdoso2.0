                        ...
                        <form action="/idosos/update" method="POST">
                            ...
                            <div class="form-group">
                                <div class="col-md-2 col-sm-10 col-md-offset-2">
                                    <label> CPF </label> 
                                    <input type="hidden" name="id" value=" {{$idosos-> id}}">
                                    <input name="cpf" type="text" maxlength="14" class="form-control"  value="{{$idosos-> cpf}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-1 col-sm-10 ">
                            ...
                            <div class="form-group">
                                <div class="col-md-5 col-sm-10 ">
                                    ...
                                    <input type="hidden" name="id" value=" {{$idosos-> id}}">
                                    <input name="descricaoal" type="text" maxlength="60" class="form-control"  value="{{$idosos-> descricaoal}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-2 col-sm-10">
                                    ...
                                    <input type="hidden" name="id" value=" {{$idosos-> id}}">
                                    <input name="telefone1" type="text" maxlength="14" class="form-control"  value="{{$idosos-> telefone1}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2 col-sm-10">
                            ...
                            <div class="form-group">
                                <div class="col-md-2 col-sm-10">
                                    ...
                                    <input type="hidden" name="id" value=" {{$idosos-> id}}">
                                    <input name="telefone2" type="text" maxlength="14" class="form-control"  value="{{$idosos-> telefone2}}">
                                </div>
                            </div>
