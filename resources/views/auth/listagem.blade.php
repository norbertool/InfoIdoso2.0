                ...
                <div id="loader" class="loader"></div>
                        <div class="section-content" style="right:0px; display: block; transform: translate3d(0px, 0px, 0px);" >
                            <a class="navbar-brand" href="/">
                              ...
                              <div class="col-md-12 col-md-offset-12 col-sm-offset-4" style="left:400px; top:-5px;">
                          <?php echo '<a id="button1id" class="button2" href="/func/logout"><i class=" fas fa-sign-out-alt"></i>&nbsp;&nbsp;&nbsp; Sair</a>'?>
                        </div>
                        </div>
                        ...
                        <div class="container">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                                        ...
                                        <tr>
                                        <td width="40px;"><a style="color: white;" class="iconified text-align:right">{{++$x}}</a></td> 
                                          
                                            <td width="400px;"><a style="color: white;">{{$p->nome}}</a></td>
                                            
                                            <td>
                                                <a style="color: white;" class="iconified text-center" href="/idosos/show/{{$p->id}}">Detalhes</a>
                                            </td>
                                            <td>
                                                <a style="color: white;" href="/idosos/remove/{{$p->id}}" onclick="return confirm('Deseja mesmo excluir este item?');">Remover</a>
                                            </td>
                                            ...
                                            <td width="150px;">
                                                ...
                                                <a style="color: white;" href="/idosos/remedios/{{$p->id}}">Remédios</a>
                                            </td>
                                        </tr>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12 col-md-offset-9 col-sm-6 col-sm-offset-3">
                                <form class="form-horizontal col-xs-10 col-xs-offset-1" method="get" action="/idosos/cadastrar">
                                    <div class="form-group">
                                        <a href="/idosos/cadastrar" target="_blank"><button class="btn btn-primary btn-circle btn-lg"><span data-tooltip="Adicione Idoso"><i class="fas fa-plus fa-1x" style="color: white;"></span></button></i></a>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-12 col-md-offset-9 col-sm-6 col-sm-offset-3">
                                <form class="form-horizontal col-xs-6 col-xs-offset-1" method="get" action="/remedios">
                                    <div class="form-group">
                                        <a href="/remedios" target="_blank"><button class="btn btn-primary2 btn-circle btn-lg"><span data-tooltip2="Página de Remédios"><i class="fa fa-pills fa-1x" style="color: white;"></span></button></i></a>
                                    </div>
                                </form>
                            </div>
